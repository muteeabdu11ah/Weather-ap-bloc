...
class WeatherModel {
  ...
  final currentWeatherData = map['current']; // Access 'current' object directly

  return WeatherModel(
    currentTemp: currentWeatherData['temp'], // Convert to double
    currentSky: currentWeatherData['weather'][0]['main'],
    currentPressure: currentWeatherData['pressure'], // Convert to double
    currentWindSpeed: currentWeatherData['wind']['speed'], // Convert to double
